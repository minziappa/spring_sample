            ...
            <div role="navigation" class="navbar-default sidebar">
                <div class="sidebar-nav navbar-collapse">
                    <ul id="side-menu" class="nav in">
                        ...
                        <li>
                        <a href="#"><i class="fa fa-files-o fa-fw"></i>Files<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li>
                                <a href="/file/uploadFiles">Up load</a>
                            </li>
                            <li>
                                <a href="/file/downloadFiles">Down load</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                        </li>
                        <li>
                        	<a href="/validator/validator"><i class="fa fa-edit fa-fw"></i> validator</a>
                        </li>
                        <li>
